...
describe("Ad HTML scraper", () => {
    ...
    it.each`
        ...
        ${"Empty FesLoader"}         | ${createHTML({})}
        ${"Missing config property"} | ${createHTML({ abc: 123 })}
        ${"Missing adInfo property"} | ${createHTML({ config: {} })}
        ${"Missing VIP property"}    | ${createHTML({ config: { adInfo: {} } })}
