...
function getFirstResultPagePath(params) {
...
function getPageResults(pageNum, firstResultPagePath) {
...
async function getSearchResults(params, minResults) {
    ...
    while (true) {
        const { pageResults, isLastPage } = await getPageResults(pageNum, firstResultPagePath);
